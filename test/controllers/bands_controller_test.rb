...
class BandsControllerTest < ActionController::TestCase
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post :create, band: { city: @band.city, email: @band.email, name: @band.name, website: @band.website }
    end
  ...
  test "should update band" do
    patch :update, id: @band, band: { city: @band.city, email: @band.email, name: @band.name, website: @band.website }
    assert_redirected_to band_path(assigns(:band))
  end
